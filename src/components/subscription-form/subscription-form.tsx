...
export const SubscriptionForm = (props: Props) => {
  ...
  const handleFirstShipment = (e: JSX.TargetedEvent<HTMLInputElement, Event>) =>
    setFirstShipmentValue(e.currentTarget.value);
  const handleDeliveryCycle = (e: JSX.TargetedEvent<HTMLInputElement, Event>) =>
    setDeliveryCycleValue(e.currentTarget.value);
  const handleDeliveryMonthlyCycle = (e: JSX.TargetedEvent<HTMLSelectElement, Event>) =>
    setDeliveryMonthlyCycleValue(e.currentTarget.value);
  const handleDeliveryDayValue = (e: JSX.TargetedEvent<HTMLSelectElement, Event>) =>
    setDeliveryDayValue(e.currentTarget.value);
  const handleDeliveryWeeklyCycleValue = (e: JSX.TargetedEvent<HTMLSelectElement, Event>) =>
    setDeliveryWeeklyCycle(e.currentTarget.value);
  const handleDeliveryDayOfWeekValue = (e: JSX.TargetedEvent<HTMLSelectElement, Event>) =>
    setDeliveryDayOfWeekValue(e.currentTarget.value);
  ...
  return (
    <div class="subscription_form" ref={myRef}>
      <fieldset>
        <legend>最初の発送</legend>
        <div>
          <input
...
register(SubscriptionForm, 'subscription-form', [], { shadow: false });
